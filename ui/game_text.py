...
story_text_lietuviu = {
    "HomeRoom": {
        "selection": ["Balkonas", "Virtuve", "Shiteris", "Eiti miegot"],
        "story": [f"Zajibal tas karštis!",
                  "Atsikėlei ištroškęs. Prakaituotas naktinis pasivartymas buvo ypatingai hujovas.",
                  "Grįžai atgal į savo kambarį, tikriausiai."],
        "player": [" ", " ", " "],
    },
    "HomeBalcony": {
        "selection": ["Kambarys", "Parukyti", "Sokt pro langa", "Balandziu lizdas"],
        "story": ["Tu balkone, čia irgi totalus dušniakas.",
                  "Po kaire, kampe, senoje kartono dėžėje yra balandžių lizdas. Kas yra visai cool.",
                  "Rodos nebeturi cigių.",
                  "Kreivai išsirangai pro langą ir sudrebinęs balkono konstrukciją pasileidi žemyn. Krenti 2.2 sekundes.",
                  "You search everywhere, but you can't find any cigarettes.",
                  "Nuspręndi grįžt atgal į kambarį."],
        "player": [" ", " ", " "],
    },
    "HomeKitchen": {
        "selection": ["Kalbeti su Mama", "Maistas", "Laukas", "Kambarys", "Nutrest cige"],
        "story": ["Įeini į virtuvę, Mama kažką kepa, rūkydama cigaretę.",
                  "Ir visiškai nekreipia į tave dėmesio.",
                  "Atidarai šaldytuvą. Viduje nerandi nieko valgomo. \nNusprendi, kad tu vis gi nealkanas.",
                  "Slenki į kambarį."],
        "player": ["\"Labas.\"", ],
        "mom": ["\"Labas.\"", ],
    },
    "HomeBathroom": {
        "selection": ["Kambarys"],
        "story": ["Tu tūlike. Nors prasivartei lovoje 11 valandų, veidrodyje matai pavargusį veidą.",
                  "Grįžti atgal į kambarį.",
                  "Čia niekas nepasikeitė."],
        "player": [" ", " ", " "],
    },
    "HomeLaiptine": {
        "story": ["Apsiauni ir išeini pro buto duris.",
                  "Randi save laiptinėje, lipant žemyn.",
                  "[NUTIKO KAŽKAS GERO] Vos prasilenkei su kaimynu neužmegzdamas akių kontakto.",
                  "[NUTIKO KAŽKAS BLOGO] Tavo ir kaimyno akys susitinka, esi priverstas pasisveikinti."],
        "player": ["\"Laba diena\"", " ", " "],
        "kaimynas": ["\"Здравствуйте\"", " ", " "],
    },
    "HomeNarvelis": {
        "selection": ["Klausyt pokalbio", "Ziuret i akis", "Varyt toliau"],
        "story": ["Tu dabar lauke, gal, lol :D.",
                  "Bet jausmas toks, kad iėjai į šiltnamį.",
                  "Kažkur 30+ metų senis sėdi ant suolo atlošo tau iš dešinės. ",
                  "Feet in black, branded flip-flops firmly placed on the sitting area of the bench. ",
                  "He's talking on the phone.",
                  "And now he's looking at you.",
                  "If by 'Stare him down' you mean 'Sourly fix your gaze on the flip-flops', then you're certainly "
